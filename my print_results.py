...
def print_results(results_dic, results_stats_dic, model, print_incorrect_dogs = False, print_incorrect_breed = False):
    ...
    print(" ")
    for key, value in results_stats_dic.keys():
        ...
        #
        # results_stats_dic: {'n_dogs_img': 30, 'n_match': 35, 'n_correct_dogs': 30, 'n_correct_notdogs': 10,
        #                     'n_correct_breed': 28, 'n_images': 40, 'n_notdogs_img': 10, 'pct_match': 87.5, 
        #                     'pct_correct_dogs': 100.0, 'pct_correct_breed': 93.33333333333333, 'pct_correct_notdogs': 100.0}
        if key.startswith('p'):
            print("{} : {}".format(results_stats_dic[key], results_stats_dic[value])
